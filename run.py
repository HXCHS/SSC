...
init()
# Function to check if the repository is outdated and perform a git pull if needed
def check_repository():
    ...
    if 'your branch is behind' in status:
        ...
        print("Repository updated. Please run the program again.")
        exit()
    else:
        print("Repository is up to date.")
# Sample user data (replace this with reading from the 'logins' file)
users = {
    "aearnes01": {"password": "pass", "clearance_level": "SSC"},
